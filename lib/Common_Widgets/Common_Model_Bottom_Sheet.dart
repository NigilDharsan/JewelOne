...
//TOTAL AMOUNT
Widget Total_Amount_Bottom_Sheet(context,
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Here is the amount breakup of your transaction for ${mobileNumber}',
          ...
          Padding(
            ...
            child: CommonContainerButton(context,
                onPress: onPress, titleName: "Proceed to Pay"),
          )
        ],
      ),
    ),
