...
class _Advance_Payment_ScreenState extends State<Advance_Payment_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Payment Equated Monthly Advance",maxLines: 2,),
        toolbarHeight: 100,
...
Widget test (){
  return Padding(
    ...
    child: Text('Select the months to make advance payment',style: maintext,),
  );
}
  ...
  return Padding(
    ...
    child: Row(
      children: [
        ...
        Text('Select all',style: maintext,),
      ],
    ),
  );
}
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('21 Feb 2024',style: plantexts,),
                        Text('₹5,000',style: plan1,),
                      ],
                    ),
                  )
                ],
...
Widget Total (){
  return Padding(
    ...
    child: Row(
      children: [
        Text('Total EMIs Payment',style: maintext,),
        const Spacer(),
